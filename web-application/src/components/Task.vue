...
<div id="app">
  <section>
    <div class="container">
      ...
      <button class="clear" @click="clearTasks">Clear Tasks</button>
    </div>
  </section>
</div>
</div>
...
:root {
    --white: rgb(255, 243, 243);
    --black: #1c2b2d;
    --blue: #31326f;
    --light-blue: #005490;
    --color-primary: #46afff;
    --color-sec: #af00db;
    --grey: #eee;
    --dark-grey: #222831;
}
...
mounted() {
    ...
    methods: {
      ...
      deleteTask(index) {
        const isConfirmed = confirm("You are about to delete this task!!!");
        if (isConfirmed) {
